						...
						<div className="postContainer">
							...
							<div className="postData">
								<div className="postContent">
									...
									<p className="postText">
										Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam quibusdam, voluptatum, quos, voluptatem voluptas quia
										quae aspernatur voluptatibus quod doloribus quas. Quisquam quibusdam, voluptatum, quos, voluptatem voluptas quia quae
										aspernatur voluptatibus quod doloribus quas.
									</p>
									<img className="postImage" src="../public/background.webp" alt="Picture" width="400" height="300" />
								</div>
								<div className="postStats">
								...
								<div className="postContainer">
									...
									<div className="postData">
										<div className="postContent">
											...
											<p className="postText">
												Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam quibusdam, voluptatum, quos, voluptatem voluptas
												quia quae aspernatur voluptatibus quod doloribus quas. Quisquam quibusdam, voluptatum, quos, voluptatem voluptas
												quia quae aspernatur voluptatibus quod doloribus quas.
											</p>
											<img className="postImage" src="../public/background.webp" alt="Picture" width="400" height="300" />
										</div>
										<div className="postStats">
