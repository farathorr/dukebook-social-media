...
export default function ReplyForm(props) {
	...
	return (
		<form className={`${style["new-post"]} ${props.disabled ? style["disabled"] : ""}`} id="reply" onSubmit={handleSubmit}>
			<p>New Reply</p>
			<textarea
				id="replyTextArea"
				value={replyText}
			...
			<div className={style["button-container"]}>
				<button className={style["post-button"]} type="submit" value="post" disabled={props.disabled}>
					Post
				</button>
				<button className={style["link-button"]} value="link" disabled={props.disabled}>
